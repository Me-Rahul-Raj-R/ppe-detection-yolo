...
PPE_BODY_REGION: dict[str, tuple[float, float]] = {
    ...
    "vest":              TORSO_REGION,
    "no-vest":           TORSO_REGION,
    "no_vest":           TORSO_REGION,
    "Glove":             TORSO_REGION,
    "No-Glove":          TORSO_REGION,
    "glove":             TORSO_REGION,
    "no_glove":          TORSO_REGION,
    "gloves":            TORSO_REGION,
    "no-gloves":         TORSO_REGION,
    "safety-suit":       TORSO_REGION,
    "safety_belt":       TORSO_REGION,
    "harness":           TORSO_REGION,
    "no_harness":        TORSO_REGION,
    "lanyard":           TORSO_REGION,
    "no_lanyard":        TORSO_REGION,
    "lanyard_good":      TORSO_REGION,
    "lanyard_bad":       TORSO_REGION,
    "hook":              TORSO_REGION,
